...
Route::get('/', [CustomerDashboard::class, 'index'])->name('landing-page');
...
Route::get('/product/{id}', [CustomerDashboard::class, 'detail'])
    ->name('product.detail');
    ...
    Route::prefix('admin')->name('admin.')->group(
        function () {
            ...
            Route::prefix('product')->name('product.')->controller(ProductController::class)->group(function () {
                ...
                Route::post(
                    '/products/store-ajax',
                    [ProductController::class, 'storeAjax']
                )->name('store.ajax');
            });

            // purchasing
            Route::prefix('purchasing')->name('purchasing.')->controller(PurchaseController::class)->group(function () {
                Route::get('/', 'index')->name('index');
                Route::post('/', 'index')->name('index');
                Route::get('/create', 'create')->name('create');
                Route::post('/', 'store')->name('store');
