...
<body>
    ...
    <section class="checkout spad">
        <div class="container">
            <div class="row">
                <!-- <div class="col-lg-12">
                    <h6><span class="icon_tag_alt"></span> Punya kupon? <a href="#">Click here</a> Masukan kupon anda
                    </h6>
                </div> -->
            </div>
                    ...
                    <div class="row">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="checkout__input">
                                        ...
                                        <input type="text" name="cust_name" placeholder="Nama anda" required>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="checkout__input">
                                        <p>Nomor Telpon<span>*</span></p>
                                        <input type="text" name="cust_phone" placeholder="Nomor Telpon" required>
                                    </div>
                                </div>
                            </div>
                            <div class="checkout__input">
                                <p>Waktu Ambil<span>*</span></p>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="checkout__order">
                                ...
                                <!-- UL kosong agar JS bisa isi otomatis -->
                                ...
                                <div class="checkout__order__subtotal">
                                    Subtotal <span>Rp{{ number_format($total, 0, ',', '.') }}</span>
                                </div>
