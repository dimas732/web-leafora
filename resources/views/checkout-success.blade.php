        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-8 text-center">
                    ...
                    <p class="mb-2">
                        Terima kasih telah berbelanja di <strong>Leafora</strong>
                    </p>
                    ...
                    <div class="mt-4">
                        <a href="{{ route('invoice.pdf', $order->invoice) }}" class="site-btn">
                            Download PDF
                        </a>

                        <a href="{{ route('landing-page') }}" class="btn btn-outline-secondary ml-2">
                            Home
                        </a>
                    </div>
