...
@push('page-action')
    <div class="btn-list">
        ...
        <a href="{{ route('admin.purchasing.create') }}" class="btn btn-primary d-none d-sm-inline-block">
                ...
                <tbody>
                    @foreach ($purchasing as $item)
                        <tr>
                            ...
                            <td class="text-capitalize">{{ $item->pur_code }}</td>
                            <td class="text-capitalize">{{ $item->purchase_date }}</td>
                            <td class="text capitalize">{{ $item->supplier?->name ?? '-' }}</td>
                            <td>Rp {{ $item->total }}</td>
                            <td>
                    ...
                    <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                ...
                                <form action="{{ route('admin.purchasing.destroy', $item->id) }}" method="POST">
                                    @csrf
                                    @method('DELETE')
                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                ...
                                <a href="{{ route('admin.purchasing.edit', $item->id) }}" class="btn btn-dark">Edit</a>
                            </div>
                        </div>
                    </div>
                </div>
